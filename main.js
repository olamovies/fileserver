...
function init(){
    ...
    if(dark){
        html += `<div id="nav" class="mdui-toolbar mdui-container mdui-text-color-white-text">
        </div>`;
    }else{
        html += `
...
function list(path) {
  var content = `
	...
	<center>
	 	 <div class="mdui-row">
	 	<div class="mdui-typo-display-3-opacity mdui-text-color-purple mdui-m-t-2">File Server by OlaMovies.Top</div>
	 	<br>
...
<a href="${href}" class="mdui-fab mdui-fab-fixed mdui-ripple mdui-color-theme-accent blink"><i class="mdui-icon material-icons">file_download</i></a>
...
<div class="mdui-container-fluid">
	<br>
	<center>
	<div class="mdui-shadow-24" style="padding: 13px; word-wrap: break-word;"> <big><b>File Name</b></big><br> ${name1}
</div>
          <br><br>
          </div><br/><br/>
...
//# sourceMappingURL=/sm/5d5d8cd2808538e7f81489e39a35aaef5e2a769c31e5234af2213fda087e35b5.map